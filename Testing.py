...
api = SmartConnect(api_key="7WMNL6yT")

# Login Number : 9730237972
# client ID : M57033620
...
login_data = api.generateSession(client_id="M57033620", 
                                 ...
                                 totp="YOUR_TOTP")  # For 2FA, use TOTP

# Extract the session data
refresh_token = login_data['data']['refreshToken']
feed_token = api.getfeedToken()

print("Login successful. Feed Token:", feed_token)

historical_params = {
    "exchange": "NSE",
    "tradingsymbol": "RELIANCE",
    "interval": "ONE_MINUTE",  # You can also use "FIVE_MINUTE", "DAILY", etc.
    "fromdate": "2023-01-01 09:15",  # Specify the start date
    "todate": "2023-01-01 16:00"     # Specify the end date
}

historical_data = api.getCandleData(historical_params)
